    ...
    >
      <div className="flex items-start gap-4 border border-accent bg-background/50 backdrop-blur-lg shadow-sm w-full rounded-2xl overflow-hidden p-6 lg:p-7">
        ...
        <div>
          ...
          <p className="text-gray-300 text-xs lg:text-sm">{t('card1Paragraph')}</p>
        </div>
      </div>
      ...
      <div className="flex items-start gap-4 border border-accent bg-background/50 backdrop-blur-lg shadow-sm w-full rounded-2xl overflow-hidden p-6 lg:p-7">
        ...
        <div>
          ...
          <p className="text-gray-300 text-xs lg:text-sm">{t('card2Paragraph')}</p>
        </div>
      </div>
      ...
      <div className="flex items-start gap-4 border border-accent bg-background/50 backdrop-blur-lg shadow-sm w-full rounded-2xl overflow-hidden p-6 lg:p-7">
        ...
        <div>
          ...
          <p className="text-gray-300 text-xs lg:text-sm">{t('card3Paragraph')}</p>
        </div>
      </div>
      ...
      <div className="flex items-start gap-4 border border-accent bg-background/50 backdrop-blur-lg shadow-sm w-full rounded-2xl overflow-hidden p-6 lg:p-7">
        ...
        <div>
          ...
          <p className="text-gray-300 text-xs lg:text-sm">{t('card4Paragraph')}</p>
        </div>
      </div>
    </div>
  );
